...
5. You will now be able to run the application in offline mode. Depending on your preferences, you may disconnect from your network or stay connected. In order to
